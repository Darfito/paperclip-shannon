...
| Aspect | v4 (live) | v6 (this package) |
|---|---|---|
...
| Name / slug | Shannon Software Factory 4 / `…` | **Shannon Software Factory 6** / `shannon-software-factory-6` |
| Version | `0.4.0` | `0.6.0` |
...
```bash
paperclipai company import --from companies/shannon-software-factory-6/
```
